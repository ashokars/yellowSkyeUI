...
export default function LocationDetailForm({ onSubmit }: Iprops) {
  ...
  useEffect(() => {
    let lk = ["location1", "location2", "location3", "location4", "location5", "location6"];
    if (location) {
      setPreview(true);
      setReadOnly(true);
          ...
          <form>
            <div className="mb-2">
              <p className="text-sm pt-4 text-[#363636]">
                Download this location template and reupload it after filling
                the details
              </p>
            </div>
            <div className="mb-2">
